...
class Detection(models.Model):
    ...
    camera_id = models.CharField(
        max_length=50, blank=True, null=True, verbose_name="카메라 ID"
    )
    image_gcs_uri = models.CharField(max_length=500, verbose_name="GCS 이미지 경로")
    ocr_result = models.CharField(
        max_length=20, blank=True, null=True, verbose_name="OCR 결과"
    )
    ocr_confidence = models.FloatField(blank=True, null=True, verbose_name="OCR 신뢰도")
